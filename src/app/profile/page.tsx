...
const Profile = () => {
  const [profileImage, setProfileImage] = useState('/images/user/user.png');
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">
                An aspiring engineer balancing academics , engaging actively in diverse extracurricular pursuits.
                </p>
              </div>
            </div>
          </div>
